...
public class QBoardData extends EntityPathBase<BoardData> {
    ...
    private static final long serialVersionUID = -1058943012L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QBoardData boardData = new QBoardData("boardData");

    public final com.joyfarm.global.entities.QBaseEntity _super = new com.joyfarm.global.entities.QBaseEntity(this);
    ...
    public final com.joyfarm.member.entities.QMember member;
    ...
    public final NumberPath<Integer> vewCount = createNumber("vewCount", Integer.class);
    ...
    public QBoardData(Class<? extends BoardData> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.joyfarm.member.entities.QMember(forProperty("member")) : null;
    }
