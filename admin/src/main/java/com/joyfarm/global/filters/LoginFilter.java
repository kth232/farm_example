package com.joyfarm.global.filters;
...
import com.joyfarm.member.repositories.JwtTokenRepository;
...
public class LoginFilter extends GenericFilterBean {
    ...
    private void loginProcess(String token) {
        ...
        try {
            ...
            headers.setBearerAuth(token); //요청을 보낼 때 토큰을 실어보내면 사용자 정보가 넘어옴
    ...
    private String getToken(ServletRequest request) {
        ...
        // 토큰이 유입된 것이 아니라면 redis 저장소에서 추출
        // id 설정 필수!
