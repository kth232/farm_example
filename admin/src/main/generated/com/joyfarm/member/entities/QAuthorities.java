...
public class QAuthorities extends EntityPathBase<Authorities> {
    ...
    private static final long serialVersionUID = -1692821673L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QAuthorities authorities = new QAuthorities("authorities");

    public final EnumPath<com.joyfarm.member.constants.Authority> authority = createEnum("authority", com.joyfarm.member.constants.Authority.class);
