package com.joyfarm.board.entities;
...
public class QBoard extends EntityPathBase<Board> {
    ...
    private static final long serialVersionUID = -630307566L;

    public static final QBoard board = new QBoard("board");

    public final com.joyfarm.global.entities.QBaseMemberEntity _super = new com.joyfarm.global.entities.QBaseMemberEntity(this);
    ...
    public final EnumPath<com.joyfarm.member.constants.Authority> commentAccessType = createEnum("commentAccessType", com.joyfarm.member.constants.Authority.class);
    ...
    public final EnumPath<com.joyfarm.member.constants.Authority> listAccessType = createEnum("listAccessType", com.joyfarm.member.constants.Authority.class);
    ...
    public final EnumPath<com.joyfarm.member.constants.Authority> replyAccessType = createEnum("replyAccessType", com.joyfarm.member.constants.Authority.class);
    ...
    public final EnumPath<com.joyfarm.member.constants.Authority> viewAccessType = createEnum("viewAccessType", com.joyfarm.member.constants.Authority.class);

    public final EnumPath<com.joyfarm.member.constants.Authority> writeAccessType = createEnum("writeAccessType", com.joyfarm.member.constants.Authority.class);
